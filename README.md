...
| 3 | **Expense Tracker** | A CLI app to manage finances — add, delete, view expenses and summaries | [roadmap.sh/projects/expense-tracker](https://roadmap.sh/projects/expense-tracker) |
