Since you built this project as a learning exercise (without external libraries like Jackson or Gson), your README should highlight that! It shows recruiters and other developers that you understand how data serialization works at a fundamental level.

Here is a professional `README.md` template tailored specifically to the code we just wrote.
